...
{
    public class Dictionary : DynamicStorage, IDictionary<string, object>, IDictionary
    {
        public Dictionary() { }
        ...
        public static Class GetClass() { return new DictionaryClass(); }
        ...
        protected override bool TrySetValue(object key, bool direct, bool forceCreate, object value)
        {
            if (key != null)
            {
                if (TryGetValue(key, true, out var member))
                {
                    Property prop;
        ...
        {
            public DictionaryClass() : base(typeof(Dictionary).Name, Enumerable.Empty<Func<Class>>(), PopulateMembers(), Enumerable.Empty<KeyValuePair<string, Func<object, object>>>()) { }

            static IEnumerable<KeyValuePair<string, object>> PopulateMembers()
            {
                yield return new KeyValuePair<string, object>("saveStruct", new Function(saveStruct, null, null));
                yield return new KeyValuePair<string, object>("assign", new Function(assign, null, null));
                yield return new KeyValuePair<string, object>("assignStruct", new Function(assignStruct, null, null));
                yield return new KeyValuePair<string, object>("clear", new Function(clear, null, null));
            }
